# -*- coding: utf-8 -*-
"""compiladores_aula04.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/187BS9NijnayY0RQryb7uBeHJouS5dXbz
"""
...
#   def gerar_erro(self, msg_erro):
#     raise ErroLexicoException('Erro léxico: {}'.format(msg_erro))
...
#         if self.buffer[i] == 'a':
#           estado = 1
#         elif self.buffer[i] == 'b':
#           estado = 0
#         else:
#           self.gerar_erro('símbolo incorreto')
#       elif estado == 1:
#         if self.buffer[i] == 'a':
#           estado = 0
#         elif self.buffer[i] == 'b':
...
#     print('A palavra {} é aceita? {}'.format(w, lexico.executar()))
...
def leia_arquivo():
  arquivo = open('/content/drive/MyDrive/compiladores/entrada.txt', 'r')
  buffer = arquivo.read()
  arquivo.close()
  return buffer
